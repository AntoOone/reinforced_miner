...
You can modify the terrain where the agent navigates on in the [grid_save](/ressources/grid_save.json) file.

You can also shape some of the terrain at runtime by using selecting the tiles on your right.
